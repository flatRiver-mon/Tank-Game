            ...
            if((bpos.x > epos[i][0] && bpos.x < epos[i][0]+30) && (bpos.y > epos[i][1] && bpos.y < epos[i][1]+30)){
                if(!$(".e"+i).hasClass("dead")){
                    ...
                    if($(".dead").length >= maxbody){
                        // .dead중에서 data 속성값이 가장 작은 녀석 선발하기
                        var arr = [];
                        for(j=0;j<$(".dead").length;j++){
                            arr[j] = $(".dead").eq(j).attr("data");
                        }
...
//                        }
    ...
    function herohit(){
        for(i=0;i<ebpos.length;i++){
            if((ebpos[i][0] > curpos.x && ebpos[i][0] < curpos.x+30 ) && (ebpos[i][1] > curpos.y && ebpos[i][1] < curpos.y+30)){
                if(!$("#hero").hasClass("respawn")){
    ...
    function enemymove(who){
        ...
        switch(edir){
            case 0:
                $(who).css("transform","rotate(270deg)").stop().animate({
                    left: "-="+emove+"px"
                },{
                    duration:3000,
                    easing:"linear",
                ...
                break;
            case 1:
                $(who).css("transform","rotate(0deg)").stop().animate({
                    top: "-="+emove+"px"
                },{
                    duration:3000,
                    easing:"linear",
                ...
                break;
            case 2:
                $(who).css("transform","rotate(90deg)").stop().animate({
                    left: "+="+emove+"px"
                },{
                    duration:3000,
                    easing:"linear",
                ...
                break;
            case 3:
                $(who).css("transform","rotate(180deg)").stop().animate({
                    top: "+="+emove+"px"
                },{
                    duration:3000,
                    easing:"linear",
